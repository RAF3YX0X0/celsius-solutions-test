/**
 * SVG Icons library for CRM application
 */

const Icons = {
  shopify: `<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19.46 6.87l-1.39-1.28c-.02-.02-.05-.03-.08-.03h-.03c-.05 0-.11.02-.15.05l-1.12.91c-.48-.68-1.1-1.22-1.82-1.58-.2-.1-.4-.18-.62-.25-.09-.32-.23-.62-.43-.89-.7-1-1.84-1.55-3.05-1.47-1.12.07-2.12.75-2.6 1.76-.23.47-.34.99-.34 1.52v.29c-.79.37-1.48.91-2.02 1.58L4.7 6.55c-.04-.04-.1-.06-.15-.06h-.03c-.03 0-.06.01-.08.03L3.06 7.8c-.08.08-.1.19-.06.29l3.35 12.38c.04.13.15.22.28.22h13.73c.13 0 .25-.09.28-.22l3.35-12.38c.04-.1.01-.21-.06-.29l-1.47-.93zm-8.83-3.23c.33-.7.99-1.17 1.76-1.22.84-.06 1.63.33 2.12 1.02.14.2.24.42.3.65l-4.18 1.4v-.35c0-.52.1-1.03.32-1.5zm-2.04 2.87c.29-.39.67-.71 1.11-.93v.81l-1.11.12zm7.72 13.78H5.68L2.73 8.35l.98-.85 1.79 1.45c.06.05.14.07.21.05.08-.02.13-.08.15-.15l.38-1.54c.73-.89 1.76-1.47 2.89-1.62l4.87 1.64c.05.02.11.01.16-.02.05-.03.09-.08.1-.14l.32-1.52c1.13.15 2.16.73 2.89 1.62l.38 1.54c.02.08.08.13.15.15.08.02.16 0 .21-.05l1.79-1.45.98.85-2.95 11.94z"/></svg>`,

  woocommerce: `<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M2.5 5.5C1.1 5.5 0 6.6 0 8v8c0 1.4 1.1 2.5 2.5 2.5h14.7c1.3 0 2.4-.9 2.7-2.2l2.3-9.5c.3-1.2-.6-2.3-1.8-2.3H2.5zm.9 3.5c.8 0 1.5.7 1.5 1.5S4.2 12 3.4 12 1.9 11.3 1.9 10.5 2.6 9 3.4 9zm4.2 0c.8 0 1.5.7 1.5 1.5S8.4 12 7.6 12 6.1 11.3 6.1 10.5 6.8 9 7.6 9zm4.2 0c.8 0 1.5.7 1.5 1.5s-.7 1.5-1.5 1.5-1.5-.7-1.5-1.5.7-1.5 1.5-1.5zm5.7 6.4c-.2.6-.7 1.1-1.3 1.1H3.6c-.6 0-1.1-.5-1.1-1.1v-1.2c.4.2.8.3 1.3.3 1.4 0 2.6-.9 3-2.1.4 1.2 1.6 2.1 3 2.1 1.4 0 2.6-.9 3-2.1.4 1.2 1.6 2.1 3 2.1.3 0 .7-.1 1-.2l-1.3 4.1z"/></svg>`,
  ...
  orders: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>`,

  customers: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`,
  ...
  simulator: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>`,
